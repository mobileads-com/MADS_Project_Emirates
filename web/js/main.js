    ...
    app.listen({
        'callback': function(msg) {
            if (typeof msg.auth != 'undefined' && typeof msg.auth.type != 'undefined' && msg.auth.type == 'closeExpandable') {
                ...
                app.tracker('E', 'duration', 'duration', diffSeconds);
